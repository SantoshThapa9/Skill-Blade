  ...
  return (
    <main className={styles.aboutpage}>
        ...
        <p>
          ...
          structured, accessible, and skill-focused learning experiences.
          Built as a college group project, it focuses on helping learners
          gain practical knowledge through an intuitive and scalable web
          platform.
        </p>
      </section>
      ...
      <section className={styles.card}>
        <h2>🎯 Our Mission</h2>
        <p>
          To make learning more engaging, accessible, and effective by
          providing students with a platform that combines modern technology
      ...
      <section className={styles.card}>
        ...
        <p>
          ...
          The primary goal is to explore modern web development practices
          while creating a useful educational platform.
        </p>
      </section>
    </main>
  );
